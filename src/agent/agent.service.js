...
var findProductByCategory_tool_1 = require("./tools/findProductByCategory.tool");
var findProductByName_tool_1 = require("./tools/findProductByName.tool");
var AgentService = function () {
    ...
    var AgentService = _classThis = /** @class */ (function () {
        function AgentService_1(productsService) {
            this.productsService = productsService;
            var llm = new llamaindex_1.OpenAI({
        ...
        AgentService_1.prototype.ask = function (prompt) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.agent.chat(prompt)];
                        case 1:
                            response = _a.sent();
