...
function createFindProductByCategoryTool(productsService) {
    var _this = this;
    return new llamaindex_1.Tool({
        name: 'findProductByCategory',
        description: '根据商品分类，返回相关商品',
        func: function (category) { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                result = productsService.findByCategory(category);
                return [2 /*return*/, result.length > 0 ? JSON.stringify(result, null, 2) : '未找到相关商品'];
            });
        }); },
    });
}
